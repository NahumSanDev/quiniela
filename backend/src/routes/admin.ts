...
router.put('/matches/:id', adminAuth, async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const { homeTeam, homeFlag, awayTeam, awayFlag, startTime, homeScore, awayScore, status, groupStage, venueName, venueCity, venueCountry, isKnockout, halfTimeHomeScore, halfTimeAwayScore, firstGoalTeam, firstGoalMinute, redCard, totalCards, extraTime, penaltyShootout, regularTimeHomeScore, regularTimeAwayScore } = req.body;
    ...
    if (regularTimeHomeScore !== undefined) updateData.regularTimeHomeScore = regularTimeHomeScore;
    if (regularTimeAwayScore !== undefined) updateData.regularTimeAwayScore = regularTimeAwayScore;
      ...
      for (const prediction of predictions) {
        ...
        const { points, bonus } = enabledBets.score || enabledBets.simpleScore || enabledBets.winnerOnly
          ? calculatePoints(
              ...
              { homeScore, awayScore, homeTeam: match.homeTeam, awayTeam: match.awayTeam },
...
router.post('/seed-worldcup', adminAuth, async (req: Request, res: Response) => {
  const worldCupMatches = [
    ...
    { homeTeam: 'Canada', homeFlag: 'ca', awayTeam: 'Morocco', awayFlag: 'ma', startTime: new Date('2026-07-04T17:00:00Z'), groupStage: 'Round of 16', isKnockout: true, venueName: 'NRG Stadium', venueCity: 'Houston', venueCountry: 'USA' },
    { homeTeam: 'Paraguay', homeFlag: 'py', awayTeam: 'France', awayFlag: 'fr', startTime: new Date('2026-07-04T21:00:00Z'), groupStage: 'Round of 16', isKnockout: true, venueName: 'Lincoln Financial Field', venueCity: 'Philadelphia', venueCountry: 'USA' },
    { homeTeam: 'Brazil', homeFlag: 'br', awayTeam: 'Norway', awayFlag: 'no', startTime: new Date('2026-07-05T20:00:00Z'), groupStage: 'Round of 16', isKnockout: true, venueName: 'MetLife Stadium', venueCity: 'East Rutherford', venueCountry: 'USA' },
    { homeTeam: 'Mexico', homeFlag: 'mx', awayTeam: 'England', awayFlag: 'gb', startTime: new Date('2026-07-06T00:00:00Z'), groupStage: 'Round of 16', isKnockout: true, venueName: 'Estadio Azteca', venueCity: 'Mexico City', venueCountry: 'Mexico' },
    { homeTeam: 'Portugal', homeFlag: 'pt', awayTeam: 'Spain', awayFlag: 'es', startTime: new Date('2026-07-06T19:00:00Z'), groupStage: 'Round of 16', isKnockout: true, venueName: 'AT&T Stadium', venueCity: 'Arlington', venueCountry: 'USA' },
    { homeTeam: 'USA', homeFlag: 'us', awayTeam: 'Belgium', awayFlag: 'be', startTime: new Date('2026-07-07T00:00:00Z'), groupStage: 'Round of 16', isKnockout: true, venueName: 'Lumen Field', venueCity: 'Seattle', venueCountry: 'USA' },
    { homeTeam: 'Argentina', homeFlag: 'ar', awayTeam: 'Egypt', awayFlag: 'eg', startTime: new Date('2026-07-07T16:00:00Z'), groupStage: 'Round of 16', isKnockout: true, venueName: 'Mercedes-Benz Stadium', venueCity: 'Atlanta', venueCountry: 'USA' },
    { homeTeam: 'Switzerland', homeFlag: 'ch', awayTeam: 'Colombia', awayFlag: 'co', startTime: new Date('2026-07-07T20:00:00Z'), groupStage: 'Round of 16', isKnockout: true, venueName: 'BC Place', venueCity: 'Vancouver', venueCountry: 'Canada' },
