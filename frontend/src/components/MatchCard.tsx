  ...
  return (
    ...
    >
      ...
      `}>
        ...
        {!isLocked && match.isKnockout && enabledBets.simpleScore && (
          <div className="mt-3" onClick={() => { setPredictionMode('simpleScore'); if (predictionMode !== 'simpleScore') setWinner(null); }}>
